...
//               >
//                 <TalkCardFrame isFlipped={activeIndex === i}>
//                   <div
//                     className={`relative w-full h-full transition-transform duration-700 preserve-3d ${
//                       activeIndex === i ? "rotate-y-180" : ""
//                     }`}
//                   >
//                     <div className="absolute bottom-3 right-3 z-30 text-[10px] text-white/60 bg-black/60 px-2 py-1 rounded-md">
//                       Tap to view details
//                     </div>
