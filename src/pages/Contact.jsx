...
const ContactFormFinal = () => {
  const form = useRef(); 
  // 1. Phone is back in state, because we now have an input for it
  ...
  // This logic now works because we are filling all 4 fields (including phone)
    ...
    >
      ...
      <div className="relative w-full max-w-[650px] group">
        ...
        >
          ...
          {/* Form */}
          <form ref={form} onSubmit={handleSubmit} className="space-y-8 relative z-30">
            ...
            {/* NEW PHONE FIELD */}
            <div className="relative group/input">
              <label className="text-[9px] font-mono text-neutral-500 mb-1 block tracking-widest uppercase">Comm_Link (Phone)</label>
              <input
                type="tel"
                name="user_phone" // Matches EmailJS variable
                placeholder="SECURE LINE (000-000-0000)"
            ...
            {/* Submit Button */}
            <button disabled={!isFormValid || isSending} type="submit"
